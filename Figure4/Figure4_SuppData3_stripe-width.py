...
def plotting_func(list_of_means_per_stimulus,list_of_sems_per_stimulus,stimuli,color_of_plot):
    ...
    plt.xticks(x, labels=['0.6', '1.3', '2.6', '5.1', '10.3', '20.6', '41.1'], rotation=0, fontsize=18)
    plt.yticks([0.25, 0.3, 0.35, 0.4, 0.45], labels=['1.5', '1.8', '2.1', '2.4', '2.7'], fontsize=18)
    plt.xlabel(xlabel="log stripe width [mm]", fontsize=20)
...
path1 = Path(r'E:\3_behaviour\stripe-widths\large-width\2024-no-gradient\Analysis\data_analysed.hdf5')
...
plotting_func(list_of_means_per_stimulus,list_of_sems_per_stimulus,stimuli,color_of_plot = "goldenrod")
...
path_to_output_folder = Path('/Volumes/Reynolds/3_behaviour/graphs-may-24/stripe-width')
mpl.rcParams.update({'font.size': 12})
stim_indexer = {'0.005': 0,
                '0.01': 1,
                '0.02': 2,
